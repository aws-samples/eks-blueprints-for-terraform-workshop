...
Replace `<GIT_PASSWORD>` with the password for workshop-user in step 2. This is the password displayed with gitea_credentials. Gitea repos use the same password as the dashboard for conviniance. 
